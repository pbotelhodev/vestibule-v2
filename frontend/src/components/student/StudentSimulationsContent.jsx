...
const simulations = [
  ...
  {
    id: "234ljkjlk234",
    title: "ENEM — Humanas completo",
    description: "História, geografia, filosofia e sociologia em um simulado.",
    area: "Humanas",
    questions: 45,
    duration: "2h",
    status: "done",
  ...
  {
    id: "23432j4k2334",
    title: "ENEM — Natureza Pro",
    description: "Biologia, física e química com relatório por matéria.",
    area: "Natureza",
    questions: 45,
    duration: "2h",
    status: "available",
  ...
  {
    id: "234jl23il43ui4",
    title: "ENEM — Simulado completo Premium",
    description: "Simulado completo com análise avançada e recomendações.",
    area: "Completo",
    questions: 180,
    duration: "5h30",
    status: "available",
