...
const RegisterPage = () => {
  ...
  return (
    <main className="relative isolate min-h-dvh overflow-x-hidden bg-white px-4 py-4 sm:px-6 2xl:px-8 xl:h-dvh xl:overflow-hidden">
      {/* Background */}
      ...
      <section className="relative z-10 grid min-h-[calc(100dvh-32px)] place-items-center xl:h-[calc(100dvh-32px)] xl:min-h-0">
        <div className="mx-auto grid w-full max-w-6xl items-center gap-8 xl:grid-cols-[0.95fr_1.05fr] 2xl:max-w-360 2xl:grid-cols-[1fr_1.05fr] 2xl:gap-12">
          ...
          <div className="mx-auto flex w-full max-w-md flex-col justify-center rounded-3xl border border-slate-200 bg-white/90 p-5 shadow-2xl shadow-violet-950/10 backdrop-blur-xl sm:p-6 lg:max-w-xl lg:p-7 xl:max-w-xl xl:p-6 2xl:min-h-155 2xl:max-w-2xl 2xl:p-9">
            ...
            <div>
              <span className="inline-flex items-center gap-1.5 rounded-full border border-violet-100 bg-violet-50 px-3 py-1 text-xs font-bold text-violet-600">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500 2xl:max-w-xl 2xl:text-base 2xl:leading-7">
                Comece com simulados, desempenho por matéria e trilhas de estudo
                personalizadas.
              </p>
            </div>

            <form className="mt-5 grid gap-3.5 sm:grid-cols-2 2xl:mt-6 2xl:gap-4">
              <div>
              ...
              <button
                type="submit"
                className="group relative overflow-hidden rounded-2xl bg-blue-950 px-5 py-3 text-sm font-extrabold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-linear-to-r hover:from-violet-600 hover:via-purple-500 hover:to-blue-600 hover:shadow-xl sm:col-span-2 2xl:py-3.5"
              >
              ...
              <button
                type="button"
                className="flex items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-extrabold text-slate-700 shadow-sm transition hover:-translate-y-0.5 hover:border-violet-200 hover:bg-slate-50 hover:text-violet-600 hover:shadow-md sm:col-span-2 2xl:py-3.5"
              >
