    ...
    <div id="produto" className="min-h-dvh overflow-x-hidden bg-white">
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-white">
          {/* Fundo quadriculado */}
          <div className="absolute inset-0 bg-[linear-gradient(rgba(15,23,42,0.025)_1px,transparent_1px),linear-gradient(90deg,rgba(15,23,42,0.025)_1px,transparent_1px)] bg-size-[32px_32px] sm:bg-size-[36px_36px]" />

          {/* Bolas sólidas com glow */}
          <div className="absolute -top-24 -right-16 size-56 rounded-full border border-blue-200/50 bg-blue-100/60 shadow-[0_30px_120px_rgba(59,130,246,0.18)] animate-[floatSoft_10s_ease-in-out_infinite] sm:right-8 sm:size-72 lg:size-80" />

          <div className="absolute -bottom-24 -left-16 size-52 rounded-full border border-amber-200/70 bg-amber-100/70 shadow-[0_30px_120px_rgba(245,158,11,0.18)] animate-[floatReverse_11s_ease-in-out_infinite] sm:left-8 sm:size-64 lg:size-72" />
          ...
          {/* Conteúdo */}
          <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-center gap-10 px-4 py-16 sm:px-6 sm:py-20 lg:min-h-[calc(100dvh-72px)] lg:gap-12 xl:flex-row xl:justify-between xl:py-12">
            {/* Hero Title */}
            <div className="w-full max-w-xl text-center xl:text-left">
              <span className="inline-flex rounded-full border border-violet-200 bg-violet-50 px-4 py-2 text-xs font-bold text-violet-600 sm:px-5 sm:text-sm">
                Uma plataforma completa para sua aprovação.
              </span>

              <h1 className="mt-6 text-4xl leading-[1.05] font-extrabold tracking-tight text-slate-950 sm:text-5xl lg:text-6xl xl:text-7xl">
                Gabarite o ENEM e alcance a sua{" "}
                <span className="text-violet-600">aprovação.</span>
              </h1>

              <p className="mx-auto mt-5 max-w-lg text-sm leading-7 text-slate-500 sm:mt-6 sm:text-base xl:mx-0">
                Simulados inteligentes, desempenho por matéria e trilhas de
                estudo para evoluir com clareza.
              </p>

              <div className="mt-8 flex w-full flex-col items-center gap-3 sm:flex-row sm:justify-center xl:justify-start">
                <a
                  href="#"
            ...
            {/* Hero Mockup */}
            <div className="w-full max-w-md sm:max-w-xl lg:max-w-2xl xl:max-w-160">
              <HeroMockup />
            </div>
          </div>
        </section>
        ...
        <section
          id="solucoes"
          className="relative mx-auto flex max-w-7xl flex-col justify-center px-4 py-16 sm:px-6 sm:py-20"
        >
          {/* Header da seção */}
          <div className="flex flex-col items-center gap-4 text-center lg:items-start lg:text-left">
            <div className={markups}>Soluções</div>

            <h2 className="max-w-2xl text-2xl font-extrabold tracking-tight text-slate-950 sm:text-3xl lg:text-4xl">
              Para quem estuda. Para quem acompanha.
            </h2>
          </div>

          {/* Cards principais */}
          <div className="mt-8 grid gap-6 lg:grid-cols-2 lg:gap-8 xl:gap-10">
            {/* Campo Aluno */}
            <div className="flex flex-col gap-6 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl sm:p-6 lg:p-7">
              {/* Header */}
              <div className="flex w-full items-center justify-between gap-4">
                <div className="flex size-12 items-center justify-center rounded-2xl bg-slate-100 text-violet-600 ring-1 ring-white/10 sm:size-13">
            ...
            {/* Campo Instituição */}
            <div className="flex flex-col gap-6 rounded-3xl border border-violet-700 bg-violet-800 p-5 text-white shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl sm:p-6 lg:p-7">
              {/* Header */}
              <div className="flex w-full items-center justify-between gap-4">
                <div className="flex size-12 items-center justify-center rounded-2xl bg-white/10 text-amber-300 ring-1 ring-white/10 sm:size-14">
              ...
              {/* Mini cards */}
              <div className="grid gap-4 sm:grid-cols-3">
                <div className="rounded-2xl border border-violet-600 bg-white/10 p-4 shadow-sm transition hover:shadow-md">
              ...
              {/* Botão */}
              <button className="flex w-full cursor-pointer items-center justify-center rounded-xl bg-white px-5 py-3 text-sm font-bold text-violet-800 transition-colors hover:bg-slate-100 sm:w-fit">
        ...
        <section
          id="recursos"
          className="relative mx-auto flex max-w-7xl flex-col justify-center border-t border-dotted border-violet-100 px-4 py-16 sm:px-6 sm:py-20 "
        >
          {/* Header da seção */}
          ...
          {/* Conteúdo */}
          <div className="mx-auto mt-10 grid w-full max-w-7xl grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
            {recursos.map((recurso, index) => (
              <div
                key={index}
                className="flex min-h-44 flex-col gap-3 rounded-3xl border border-violet-100 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:border-violet-200 hover:shadow-lg sm:p-6"
              >
        ...
        >
          ...
          {/* Cards */}
          <div className="mx-auto mt-10 grid w-full grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
            {planos.map((plan) => (
              <div
                key={plan.name}
                className={`relative flex flex-col rounded-4xl p-6 transition hover:-translate-y-1 ${
                  plan.dark
              ...
              >
                {plan.badge && (
                  <div className="absolute top-6 right-6 rounded-full bg-violet-100 px-3 py-1 text-[10px] font-extrabold tracking-wide text-violet-700 uppercase">
                    {plan.badge}
                  </div>
                )}
                ...
                <a
                  href="#"
                  className={`mt-7 flex w-full items-center justify-center rounded-2xl px-5 py-3 text-sm font-bold transition hover:-translate-y-0.5 ${
                    plan.dark
