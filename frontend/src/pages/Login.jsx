...
const LoginPage = () => {
  ...
  return (
    <main className="relative isolate min-h-dvh overflow-x-hidden bg-white px-4 py-4 sm:px-6 lg:px-8 xl:h-dvh xl:overflow-hidden 2xl:px-10">
      ...
      {/* Área central */}
      <section className="relative z-10 grid min-h-[calc(100dvh-32px)] place-items-center py-2 xl:h-[calc(100dvh-32px)] xl:min-h-0 xl:py-0">
        <div className="mx-auto grid w-full max-w-7xl items-center gap-6 lg:max-w-3xl xl:max-w-6xl xl:grid-cols-[0.92fr_1fr] xl:gap-8 2xl:max-w-340 2xl:grid-cols-[1fr_1.05fr] 2xl:gap-12">
          {/* Esquerda */}
          <div className="hidden w-full flex-col items-start justify-center xl:flex">
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="mb-4 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-bold text-slate-500 shadow-sm transition hover:-translate-x-0.5 hover:border-violet-200 hover:bg-violet-50 hover:text-violet-600 hover:shadow-md 2xl:mb-6"
            >
            ...
            <div className="max-w-md 2xl:max-w-xl">
              <h1 className="text-3xl leading-[1.05] font-extrabold tracking-tight text-slate-950 2xl:text-5xl">
                Entre e continue sua preparação com clareza.
              </h1>

              <p className="mt-3 max-w-lg text-sm leading-6 font-light text-slate-500 2xl:mt-4 2xl:text-base 2xl:leading-7">
                Acesse simulados, acompanhe sua evolução e visualize os próximos
                passos da sua rotina de estudo em um só lugar.
              </p>
            </div>

            {/* Mockup compacto */}
            <div className="mt-5 w-full max-w-md overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl shadow-violet-950/10 2xl:mt-7 2xl:max-w-xl">
              <div className="flex items-center gap-3 bg-slate-950 px-4 py-2.5">
              ...
              <div className="bg-white p-3.5 2xl:p-5">
                <div className="grid gap-3 sm:grid-cols-[1.1fr_0.9fr]">
                  <div className="rounded-3xl bg-blue-700 p-3.5 text-white shadow-sm 2xl:p-5">
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <h3 className="mt-2 text-2xl font-extrabold tracking-tight 2xl:text-3xl">
                          760 pts
                        </h3>
                  ...
                  <div className="rounded-3xl border border-slate-200 bg-white p-3.5 shadow-sm 2xl:p-5">
                    <p className="text-xs font-bold text-slate-500">
                      Acerto geral
                    </p>

                    <div className="mt-2 flex items-end justify-between gap-3">
                      <h3 className="text-2xl font-extrabold tracking-tight text-slate-950 2xl:text-3xl">
                        76%
                      </h3>
                ...
                <div className="mt-3 rounded-3xl border border-slate-200 bg-white p-3.5 shadow-sm 2xl:p-5">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h3 className="mt-2 text-base font-extrabold tracking-tight text-slate-950 2xl:text-lg">
                        Diagnóstico ENEM
                      </h3>
                    </div>
          ...
          {/* Direita */}
          <div className="mx-auto flex w-full max-w-md flex-col justify-center rounded-3xl border border-slate-200 bg-white/90 p-5 shadow-2xl shadow-violet-950/10 backdrop-blur-xl sm:p-6 lg:max-w-xl lg:p-7 xl:min-h-130 xl:max-w-lg xl:p-6 2xl:min-h-155 2xl:max-w-2xl 2xl:p-9">
            {/* Topo mobile/tablet/lg */}
            ...
            {/* Logo desktop */}
            <div className="mb-4 hidden xl:block 2xl:mb-6">
              <Logo />
            </div>
            ...
            {/* Seletor */}
            <div className="mt-4 grid grid-cols-2 gap-3 2xl:mt-5">
              <button
                type="button"
                onClick={() => {
                  setIsSchool(false);
                ...
                className={`cursor-pointer rounded-2xl border border-violet-200 ${selectedRole === "aluno" ? "bg-violet-50 text-violet-600" : "bg-white text-slate-500"} px-4 py-2.5 text-sm font-extrabold shadow-sm transition hover:bg-violet-100 2xl:py-3`}
              >
                Aluno
              </button>
              ...
              <button
                ...
                onClick={() => {
                  setIsSchool(true);
                  setSelectedRole("escola");
                }}
                className={`rounded-2xl border border-slate-200 ${selectedRole === "escola" ? "bg-violet-50 text-violet-600" : "bg-white text-slate-500"} px-4 py-2.5 text-sm font-extrabold shadow-sm transition hover:bg-violet-100 2xl:py-3`}
              >
                Instituição
              </button>
            </div>

            <form className="mt-4 grid gap-3 2xl:mt-5 2xl:gap-4">
              <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div className={`${isSchool ? "md:col-span-1" : "md:col-span-2"}`}>
                  <div className="flex items-center justify-between gap-4">
                    <label className="text-sm font-bold text-slate-700">
                      Senha
                    </label>
                    ...
                    <Link
                      to="/recuperar-senha"
                      className="text-[10px] font-bold text-violet-600 transition hover:text-violet-700"
                    >
                      Esqueci minha senha
                    </Link>
                  </div>
              ...
              <button
                type="submit"
                className="group relative overflow-hidden rounded-2xl bg-blue-950 px-5 py-3 text-sm font-extrabold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-linear-to-r hover:from-violet-600 hover:via-purple-500 hover:to-blue-600 hover:shadow-xl 2xl:py-3.5"
              >
